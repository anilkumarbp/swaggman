...
module.exports = (swaggerJSON, ...options) => {
    ...
    console.log('typeof process.env.POSTMAN_DESCRIPTION: ', typeof process.env.POSTMAN_DESCRIPTION);
    ...
    console.log('swaggerJSON.info.description: ', swaggerJSON.info.description);
    console.log('postmanDescription: ', postmanDescription);
